...
Provide a dedicated aggregated view of expenses grouped by category. Shop owners can see at a glance how much they have spent in each category (alimentaire, boissons, hygiène, etc.) without manually calculating totals.
...
- Categories with zero expenses SHALL be clearly distinguishable (displayed with "0" count and "0,00 MAD" total)
