...
Define the asynchronous queue processing for AI extraction of supplier receipts, ensuring the user never waits for the AI response inside an HTTP request.
