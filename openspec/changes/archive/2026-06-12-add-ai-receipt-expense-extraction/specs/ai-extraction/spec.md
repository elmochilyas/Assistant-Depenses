...
- The agent SHALL extract each purchased item, normalize labels, infer category from allowed enum values only, preserve quantities as integers and unit prices as numeric values
